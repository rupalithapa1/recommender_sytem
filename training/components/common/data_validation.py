...
class DataValidation:
    def __init__(self, config: DataValidationConfig):  # Fixed '__init__' method definition
        self.config = config
    ...
    def validate_file_exists(self):
        ...
        info_logger.info("Source file exists.")
    ...
    def validate_columns(self, df: pd.DataFrame):
        ...
        """
        required_columns = [
            'UserID', 'ItemID', 'Rating', 'PurchaseHistory', 'CartActivity',
            'WishlistActivity', 'Clicks', 'Views', 'TimeSpentOnItem', 'PurchaseDate',
            'SessionDuration', 'DeviceType', 'AbandonedCartData', 'Age', 'Gender', 'Location',
            'Income', 'Occupation', 'SignUpDate', 'MembershipLevel', 'BrowsingHistory',
            'Device', 'TimeOfInteraction', 'SearchQueries', 'ProductName', 'Category',
        ...
        info_logger.info("All required columns are present.")
    ...
    def validate_data_types(self, df: pd.DataFrame):
        ...
        """
        expected_types = {
            'ItemID': object, 'Rating': int, 'PurchaseHistory': object,
            'CartActivity': object, 'WishlistActivity': object, 'Clicks': int,
            'Views': int, 'TimeSpentOnItem': float, 'PurchaseDate': 'datetime64[ns]',
            'SessionDuration': float, 'DeviceType': object, 'AbandonedCartData': object,
            'Age': int, 'Gender': object, 'Location': object, 'Income': object,
            'Occupation': object, 'SignUpDate': 'datetime64[ns]', 'MembershipLevel': object,
            'BrowsingHistory': object, 'Device': object, 'TimeOfInteraction': object,
            'SearchQueries': object, 'ProductName': object, 'Category': object,
            'Price': float, 'Discount': float, 'Brand': object, 'Description': object,
            'Tags': object, 'Color': object, 'Size': object, 'Stock': int,
            'Ratings': float, 'Reviews': object, 'ReleaseDate': 'datetime64[ns]',
